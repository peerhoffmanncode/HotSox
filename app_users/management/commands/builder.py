...
def gen_sock(user):
    ...
    sock = Sock(
        ...
        info_color=str(random.randint(0, 9)),
        info_fabric=str(random.randint(0, 6)),
        info_fabric_thickness=str(random.randint(0, 6)),
        info_brand=str(random.randint(0, 12)),
        info_type=str(random.randint(0, 8)),
        info_size=str(random.randint(0, 6)),
        info_age=random.randint(0, 5),
        info_separation_date=date.today() - timedelta(356 * (random.randint(0, 5))),
        info_condition=str(random.randint(0, 11)),
        info_holes=random.randint(0, 4),
        info_kilometers=random.randint(0, 250),
        info_inoutdoor=str(random.randint(0, 8)),
